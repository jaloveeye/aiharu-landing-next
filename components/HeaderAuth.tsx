          ...
          <nav className="hidden md:flex space-x-6">
            <Link
              ...
              className={`relative px-3 py-2 text-sm font-medium transition-colors ${
                pathname === "/about"
                  ? "text-green-600 font-bold after:absolute after:bottom-0 after:left-0 after:right-0 after:h-0.5 after:bg-green-600 after:rounded-full after:pointer-events-none"
