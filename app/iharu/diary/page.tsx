        ...
        <div className="space-y-6">
          {diaryEntries.length === 0 ? (
            <div className="bg-white rounded-xl shadow-sm p-12 text-center">
              ...
              <p className="text-gray-600 mb-6">첫 번째 일일 기록을 작성해보세요!</p>
              <Link
                href="/iharu/diary/create"
            ...
            diaryEntries.map((entry) => (
              ...
              >
                ...
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="text-right">
                    <div className="text-3xl mb-1">{getMoodEmoji(entry.mood_rating)}</div>
                ...
                {entry.activities && entry.activities.length > 0 && (
                  <div className="mb-4">
                    <h4 className="font-semibold text-gray-700 mb-2">오늘의 활동</h4>
                ...
                {entry.highlights && (
                  <div className="mb-4">
                    <h4 className="font-semibold text-gray-700 mb-2">특별한 순간</h4>
                ...
                {entry.challenges && (
                  <div className="mb-4">
                    <h4 className="font-semibold text-gray-700 mb-2">도전과제</h4>
                ...
                {entry.parent_notes && (
                  <div className="mb-4">
                    <h4 className="font-semibold text-gray-700 mb-2">부모님 메모</h4>
                ...
                {entry.child_notes && (
                  <div className="mb-4">
                    <h4 className="font-semibold text-gray-700 mb-2">아이 메모</h4>
                  ...
                  <div className="mb-4">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
                      {entry.photos.map((photo, index) => (
                        ...
                        >
                          <span className="text-gray-500 text-sm">사진 {index + 1}</span>
                        </div>
                      ))}
                    </div>
                  </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <div className="text-center">
                <div className="text-2xl font-bold text-green-600">
                  {diaryEntries.filter(e => e.mood_rating && e.mood_rating >= 4).length}
                </div>
                <div className="text-sm text-gray-600">좋은 하루</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-purple-600">
                  {diaryEntries.filter(e => e.activities && e.activities.length > 0).length}
                </div>
                <div className="text-sm text-gray-600">활동 기록</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-orange-600">
                  {diaryEntries.filter(e => e.photos && e.photos.length > 0).length}
                </div>
