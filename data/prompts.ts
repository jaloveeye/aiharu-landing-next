...
export const promptTemplates: PromptExample[] = [
  ...
  // 비즈니스 & 경영
  {
    ...
    category: "비즈니스마케팅",
    prompt:
      "현대 비즈니스 환경에서 발생하는 복잡한 마케팅 도전 과제와 전략적 문제를 구체적으로 제시해주세요. 예: 디지털 마케팅 전략 수립, 고객 세분화 및 타겟팅, 브랜드 아이덴티티 구축, 마케팅 성과 측정 및 ROI 분석, 경쟁사 분석 및 차별화 전략, 신제품 출시 마케팅, 고객 유지 및 충성도 향상, 글로벌 마케팅 전략, 데이터 기반 의사결정, 마케팅 자동화 및 기술 도입 등. 구체적인 시장 상황, 기업 규모, 예산 제약, 경쟁 환경, 고객 행동 변화를 포함하여 실제 마케터가 마주할 수 있는 복합적인 문제를 다루어주세요.",
    tags: ["비즈니스마케팅", "마케팅", "전략", "디지털마케팅"],
    difficulty: "고급",
    createdAt: "2025-01-20",
    updatedAt: "2025-01-20",
  },
  // 일상 & 라이프스타일
  {
    ...
    category: "일상라이프",
    prompt:
      "현대인의 복잡한 일상에서 생산성을 높이고 삶의 질을 개선하는 구체적인 방법과 전략을 제시해주세요. 예: 시간 블로킹 및 우선순위 설정, 습관 형성 및 유지, 업무-생활 균형 조절, 스트레스 관리 및 정신 건강, 디지털 웰빙 및 스크린 타임 관리, 건강한 식습관 및 운동 루틴, 인간관계 및 소통 개선, 재정 관리 및 투자 전략, 창의성 및 혁신 사고, 지속가능한 라이프스타일 등. 구체적인 연령대, 직업 환경, 가족 상황, 개인적 제약사항을 포함하여 실제 현대인이 마주할 수 있는 복합적인 문제를 다루어주세요.",
    tags: ["생산성", "시간관리", "습관", "웰빙", "라이프스타일"],
    difficulty: "고급",
    createdAt: "2025-01-20",
    updatedAt: "2025-01-20",
  },
